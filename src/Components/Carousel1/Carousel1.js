...
const MyCarousel1 = (props) => {
    ...
    let photos = [{id:1, photo: sharify, link: 'http://64.227.104.65:3333/', content: 'The technology used to do authentication for this project was BCrypt.JS. I used my Postgres database to store the hash value of the users password for security. The system is set up to login and register users and very importantly to not allow duplicate information. The application is setup with middleware for detecting privillages and allowing for a person with Admin rights to have full C-R-U-D througout the application. Admin users can Add and Delete Properties, Persons, and update details about a house such as price and if it is availble.    '}, {id:2, photo: chat, link: 'http://64.227.104.65:3333/Chat'}, { id:3, photo: chart, link: 'https://github.com/Most-Basic33'}, {id:4, photo: audio, link: 'http://64.227.104.65:3333/Chat'}]
